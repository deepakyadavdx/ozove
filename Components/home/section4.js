...
//           }`}
//         >
//           <div className="px-3 web-section-4">
...
//                 />
//                 {/* </div> */}
//                 <p className="text-center text-grey fw-bold text-uppercase hyper_text">
...
//                 <div>
//                   <div>
//                     <div className="text-black why_oz_head text-uppercase fw-bolder">
//                       Why Choose Oz Ove?
//                     </div>
...
//                     </div>
//                   </div>
//                   <div className="flex-row my-3 d-flex align-items-center">
...
//             </div>
//           </div>
//           <div className="p-2 mob-section-4">
//             <div className="mx-0 row w-100">
//               <div className="px-0 d-flex justify-content-start align-items-start flex-column">
//                 <div className="rotate-container">
//                   <Image
//                     loader={myLoader}
//                     src={Logo1}
...
//                   <div className="flex-row py-2 bg-white d-flex rounded-3 me-2 ps-2 pe-3 align-items-center">
//                     <Affordable className="mx-2" style={{ width: "50px" }} />
//                     <div className="text-black fs-12 fw-700">
//                       Convenience is Key
//                     </div>
//                   </div>
//                   <div className="flex-row py-2 mx-2 bg-white d-flex rounded-3 ps-2 pe-3 align-items-center">
...
function SectionFour() {
  ...
  }, [isMobile, isTablet, isPhone]); // Dependencies added here
