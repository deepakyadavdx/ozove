...
const Map = (props) => {
  ...
  useEffect(() => {
    ...
    map.current.on("load", () => {
      // Map is fully loaded, now we can call getRouteLine
      getRouteLine(props);
    });
  ...
  }, [lng, lat, zoom]); // Dependencies added here
  ...
  useEffect(() => {
    if (map.current && map.current.loaded()) {
      // Map is already loaded, we can call getRouteLine
      getRouteLine(props);
    }
  }, [props]); // Dependency on props added here
