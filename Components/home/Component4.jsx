  ...
  return (
    <div className="">
      <div className="max-w-md p-4 mx-auto bg-white shadow-md ">
        ...
        <div className="mb-1 ">
          <Component3 label="" onSelect={setPickup} />
        </div>
        <div className="mb-4">
          <Component3 label="" onSelect={setDestination} />
        </div>
        ...
        <div className="mb-4 ">
          ...
          {stop && <Component3 label="Stop Location" onSelect={setStop} />}
        </div>
        ...
        <div className="mb-4">
          ...
          {vehicleType && (
            <div className="w-full p-1 mt-2 text-black border-yellow-600 rounded-md text-blackborder bg-customYellow">
