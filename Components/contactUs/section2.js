    ...
    <>
      <div className="py-5">
        <div className="container">
          <div className="mx-0 row w-100">
            <div
              className={`col-md-4 text-center order-2 order-lg-1 ${
                isMobile ? "contact_card rounded my-3 py-5" : ""
              }`}
            >
              <Image
                loader={myLoader}
            ...
            <div
              className={`col-md-4 text-center order-1 order-lg-2 ${
                isMobile ? "contact_card rounded my-3 py-5" : ""
              }`}
            >
              <Image
            ...
            >
              ...
              <div>
                <p className="contact_head">Our Office</p>
                <p className="contact_desc">
                  Our office address Level 1 45 St Georges Terrace,
                  <br />
                  Perth, WA 6000
                </p>
              </div>
