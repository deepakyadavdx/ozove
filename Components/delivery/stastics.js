...
//           <div className="mx-0 row w-100 justify-content-evenly">
...
//               <p className="my-2 text-grey why_choose_sub fw-600">Your local delivery partner</p>
//               <div className="flex-row my-2 d-flex row">
...
//               <p className="my-2 text-grey why_choose_sub fw-600 text-capitalize">Your local delivery partner</p>
//               <div className="overflow-auto d-flex">
//                 <div className="flex-row p-2 mx-2 d-flex rounded-3 align-items-center">
//                   <div>
      ...
      <div className="container">
        <div className="mx-0 row w-100 justify-content-evenly">
          <div className="col-lg-6 d-flex justify-content-start justify-content-lg-center align-items-center">
            <Image
              loader={myLoader}
              className={`object-fit-contain ${isMobile ? "h-100 w-75" : ""} ${
                isTablet ? "h-100 w-50" : " h-auto w-75"
              }`}
              src={DeliveryPartner}
              alt="DeliveryPartner"
            />
          ...
          <div className="col-lg-5 d-none d-lg-block h-100">
            <p className="text-black why_choose_head">
              Why choose <span className="text-socialiconyellow">Oz</span>ove?
            </p>
            <p className="my-2 text-grey why_choose_sub fw-600">
            ...
            <div className="flex-row my-2 d-flex row">
              <div className="px-0 col-md-1">
                <Image
                  loader={myLoader}
                  className="me-3 object-fit-contain icon_1_width"
                  src={Ready}
                  alt="Ready"
                />
              </div>
              <div className="col-md-11">
                ...
                <div className="text-dark stastics_desc">
                  Connect with a delivery driver in just a few seconds,
                  they&apos;ll arrive at your chosen pick up spot in no time at
                  all.
                </div>
              </div>
            </div>
            <div className="flex-row my-2 d-flex row">
              <div className="px-0 col-md-1">
                <Image
                  loader={myLoader}
                  className="me-3 object-fit-contain icon_2_width"
                  src={Professional}
                  alt="Professional"
                />
              </div>
              <div className="col-md-11">
                ...
                <div className="text-dark stastics_desc">
                  Have peace of mind with our trained and fully vetted delivery
                  drivers
                </div>
              </div>
            </div>
            <div className="flex-row my-2 d-flex row">
              <div className="px-0 col-md-1">
                <Image
                  loader={myLoader}
                  className="me-3 object-fit-contain icon_3_width"
                  src={Save}
                  alt="Save"
                />
              </div>
              <div className="col-md-11">
                ...
                <div className="text-dark stastics_desc">
                  Let us do the hard work for you. We&apos;ll get your goods
                  across town and even do the heavy lifting if you need help.
                </div>
              </div>
            </div>
            <div className="flex-row my-2 d-flex row">
              <div className="px-0 col-md-1">
                <Image
                  loader={myLoader}
                  className="me-4 object-fit-contain icon_4_width"
                  src={Everything}
                  alt="Everything"
                />
              </div>
              <div className="col-md-11">
                ...
                <div className="text-dark stastics_desc">
                  Schedule a delivery, make a payment and track your goods all
                  in one app. It&apos;s the only complete on-demand delivery
          ...
          <div className="col-lg-6 d-block d-lg-none mob-stastics">
            <p className="text-grey why_choose_head">Why choose Ozove?</p>
            <p className="my-2 text-grey why_choose_sub fw-600 text-capitalize">
              Your local delivery partner
            </p>
            <div className="overflow-auto d-flex">
              <div className="flex-row p-2 mx-2 d-flex rounded-3 align-items-center">
