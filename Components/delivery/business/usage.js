...
//                 <button
//                   className="px-1 nav-link w-100 d-flex align-items-center justify-content-center pills-hyperlocal"
//                   data-bs-toggle="pill"
...
//                     <li className="my-2 nav-item" role="presentation">
//                       <button
//                         className="p-3 nav-link w-100 fs-5"
...
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Oz Ove Now Services</h2>
//                               <p className='my-2 text-dark'>Low-cost & convenient deliveries, done under 45 minutes, apt for food, pharma, & groceries orders</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Realtime serviceability check</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Cross-category utilisation</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Marketplace Fleet Access</p>
//                               </div>
//                             </div>
//                           </div>
...
//                           <div className='col-lg-5'>
//                             <div className='p-2 bg-white card h-100'>
//                               <p className='my-2 text-dark text-uppercase fw-700 fs-5'>
//                                 Benefits
//                               </p>
//                               <div className='my-3'>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Retail Logistics</h2>
//                               <p className='my-2 text-dark'>Reliable express logistics for Quick Service Restaurants/Retail chains that demand a dedicated on-time delivery fleet to boost customer experience.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner allocation</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Order delivery validation</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> State-of-the-art tracking</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Oz Ove - Plus</h2>
//                               <p className='my-2 text-dark'>We have a specified logistics fleet for high value category products such as meat, alcohol & luxurry goods that require highly skilled delivery partners.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skills mapped</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Order pick-up validation</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Reverse logistics (KYC failures)</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Oz Ove - Next</h2>
//                               <p className='my-2 text-dark'>Crossed-utilised, dedicated & skilled logistics fleet for handling high-priority & critical documents, handled with utmost safety, at budget-friendly rates.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Multi-vertical partner utilisation</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skill mapping</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skill mapping</p>
//                               </div>
//                             </div>
//                           </div>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Now Slot - Store Pick up model</h2>
//                               <p className='my-2 text-dark'>Our store pick-up model works with dark and live stores, handling slotted and express deliveries, doorstep returns, and fluctuations in consumer demands. Optimized for outsourced manpower models, like pharma & postman services, prioritizing speed & accuracy.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Desired slot-time delivery</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Real-time reconciliation & customer refund</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Resource deployment for maximum efficacy</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                     <li className="my-2 nav-item" role="presentation">
//                       <button
//                         className="p-3 nav-link w-100 active fs-5"
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Standard Delivery</h2>
//                               <p className='my-2 text-dark'>Have your order conveniently delivered to your doorstep within just 4 hours.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Quick delivery within 4 hours.</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Convenient doorstep service</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Instant gratification without waiting</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Same Day Delivery</h2>
//                               <p className='my-2 text-dark'>Experience the convenience of having your order delivered right to your doorstep during office hours.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery within office hours</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Immediate access to your order.</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Flexible timing for convenience.</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                           <div className='col-lg-7'>
//                             <div>
//                               <h2 className='my-2 text-dark fw-600 text-capitalize'>Next-Day Delivery</h2>
//                               <p className='my-2 text-dark'>Enjoy the prompt delivery of your order, arriving at your doorstep within 1-2 business days.</p>
//                               <div className='my-3'>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Fast and reliable services</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Easy planning with 1-2 business day delivery.</p>
//                                 <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Efficient and timely arrival</p>
//                               </div>
//                             </div>
//                           </div>
//                           <div className='col-lg-5'>
...
//                     <div className='col-lg-7'>
//                       <div>
//                         <h2 className='my-2 text-dark fw-600 text-capitalize'>E-Com Forward</h2>
//                         <p className='my-2 text-dark'>On-time, end-to-end forward logistics with a high delivery percentage that caters to rapidly increasing e-commerce demands, at lower costs.</p>
//                         <div className='my-3'>
//                           <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Marketplace & warehouse pick-ups</p>
//                           <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> End-toend shippment tracking</p>
//                           <p className='text-black fw-600'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> COD doorstep payments</p>
//                         </div>
//                       </div>
//                     </div>
//                     <div className='col-lg-5'>
...
//                       <li className="my-2 nav-item" role="presentation">
//                         <button
//                           className="px-1 nav-link w-100 fs-15"
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Oz Ove Now Services</h2>
//                                 <p className='my-2 text-dark fs-10'>Low-cost & convenient deliveries, done under 45 minutes, apt for food, pharma, & groceries orders</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Realtime serviceability check</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Cross-category utilisation</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Marketplace Fleet Access</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                             </div>
//                             <div className='my-3'>
//                               <div className='p-2 bg-white card h-100 card_1'>
//                                 <p className='my-2 text-dark text-uppercase fw-700 fs-16'>
//                                   Benefits
//                                 </p>
//                                 <div className='my-3'>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Retail Logistics</h2>
//                                 <p className='my-2 text-dark fs-10'>Reliable express logistics for Quick Service Restaurants/Retail chains that demand a dedicated on-time delivery fleet to boost customer experience.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner allocation</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Order delivery validation</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> State-of-the-art tracking</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Oz Ove - Plus</h2>
//                                 <p className='my-2 text-dark fs-10'>We have a specified logistics fleet for high value category products such as meat, alcohol & luxurry goods that require highly skilled delivery partners.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skills mapped</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Order pick-up validation</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Reverse logistics (KYC failures)</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Oz Ove - Next</h2>
//                                 <p className='my-2 text-dark fs-10'>Crossed-utilised, dedicated & skilled logistics fleet for handling high-priority & critical documents, handled with utmost safety, at budget-friendly rates.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Multi-vertical partner utilisation</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skill mapping</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery partner skill mapping</p>
//                                 </div>
//                               </div>
//                             </div>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Now Slot - Store Pick up model</h2>
//                                 <p className='my-2 text-dark fs-10'>Our store pick-up model works with dark and live stores, handling slotted and express deliveries, doorstep returns, and fluctuations in consumer demands. Optimized for outsourced manpower models, like pharma & postman services, prioritizing speed & accuracy.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Desired slot-time delivery</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Real-time reconciliation & customer refund</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Resource deployment for maximum efficacy</p>
//                                 </div>
//                               </div>
//                             </div>
//                             <div className='col-lg-5'>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Standard Delivery</h2>
//                                 <p className='my-2 text-dark fs-10'>Have your order conveniently delivered to your doorstep within just 4 hours.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Quick delivery within 4 hours.</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Convenient doorstep service</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Instant gratification without waiting</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Same Day Delivery</h2>
//                                 <p className='my-2 text-dark fs-10'>Experience the convenience of having your order delivered right to your doorstep during office hours.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Delivery within office hours</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Immediate access to your order.</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Flexible timing for convenience.</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                             <div className='col-lg-7'>
//                               <div>
//                                 <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>Next-Day Delivery</h2>
//                                 <p className='my-2 text-dark fs-10'>Enjoy the prompt delivery of your order, arriving at your doorstep within 1-2 business days.</p>
//                                 <div className='my-3'>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Fast and reliable services</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Easy planning with 1-2 business day delivery.</p>
//                                   <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Efficient and timely arrival</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                       <div className='col-lg-7'>
//                         <div>
//                           <h2 className='my-2 text-dark fw-600 text-capitalize fs-22'>E-Com Forward</h2>
//                           <p className='my-2 text-dark fs-10'>On-time, end-to-end forward logistics with a high delivery percentage that caters to rapidly increasing e-commerce demands, at lower costs.</p>
//                           <div className='my-3'>
//                             <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> Marketplace & warehouse pick-ups</p>
//                             <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> End-toend shippment tracking</p>
//                             <p className='text-black fs-14 fw-600 d-flex align-items-center'><Image loader={myLoader} className="h-auto points" src={Points} alt='Points' /> COD doorstep payments</p>
//                           </div>
//                         </div>
//                       </div>
//                     </div>
          ...
          <div className="row justify-content-center Hyper_Local_Section_Options d-none d-lg-flex">
              ...
              >
                ...
                >
                  <Image
                    ...
                    src={HyperlocalActive}
                    alt="HyperlocalActive"
                  />
                  <Image
                    loader={myLoader}
                    style={{ width: isLaptop ? "80%" : "100%" }}
            ...
            <div className="mt-5 tab-content" id="pills-tabContent">
              <div
                ...
                id="pills-hyperlocal"
                role="tabpanel"
                aria-labelledby="pills-hyperlocal-tab"
              >
                <div className="row d-flex">
                  <ul
                  ...
                  <div className="tab-content col-md-8" id="pills-tabContent">
                    <div
                      ...
                      id="pills-ozOveNow"
                      role="tabpanel"
                      aria-labelledby="pills-ozOveNow-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Low-cost & convenient deliveries, done under 45
                                minutes, apt for food, pharma, & groceries
                                orders
                              </p>
                              <div className="my-3">
                        ...
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div className="p-2 bg-white card h-100">
                              <div className="d-flex justify-content-between">
                                <div>
                                  <p className="text-dark text-uppercase fw-700 fs-5">
                                    Who is it for?
                                  </p>
                                </div>
                                <div>
                          ...
                          <div className="col-lg-5">
                            <div className="p-2 bg-white card h-100">
                              ...
                              <div className="my-3">
                                <p className="fw-700">Peak Management</p>
                                <p className="fs-15">
                                  Upto 100% flex in order volumes
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div
                      ...
                      id="pills-retailLogistics"
                      role="tabpanel"
                      aria-labelledby="pills-retailLogistics-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Reliable express logistics for Quick Service
                                Restaurants/Retail chains that demand a
                                dedicated on-time delivery fleet to boost
                                customer experience.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                    ...
                    <div
                      ...
                      id="pills-ozOvePlus"
                      role="tabpanel"
                      aria-labelledby="pills-ozOvePlus-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                We have a specified logistics fleet for high
                                value category products such as meat, alcohol &
                                luxurry goods that require highly skilled
                                delivery partners.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Delivery partner skills mapped
                                </p>
                                <p className="text-black fw-600">
                                  <Image
                                    loader={myLoader}
                                ...
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Reverse logistics (KYC failures)
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div
                      ...
                      id="pills-ozOveNext"
                      role="tabpanel"
                      aria-labelledby="pills-ozOveNext-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Crossed-utilised, dedicated & skilled logistics
                                fleet for handling high-priority & critical
                                documents, handled with utmost safety, at
                              ...
                              <div className="my-3">
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Multi-vertical partner utilisation
                                </p>
                                <p className="text-black fw-600">
                                  <Image
                                    loader={myLoader}
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Delivery partner skill mapping
                                </p>
                                <p className="text-black fw-600">
                                  <Image
                                    loader={myLoader}
                    ...
                    <div
                      ...
                      id="pills-nowSlot"
                      role="tabpanel"
                      aria-labelledby="pills-nowSlot-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              <h2 className="my-2 text-dark fw-600 text-capitalize">
                                Now Slot - Store Pick up model
                              </h2>
                              <p className="my-2 text-dark">
                                Our store pick-up model works with dark and live
                                stores, handling slotted and express deliveries,
                                doorstep returns, and fluctuations in consumer
                                demands. Optimized for outsourced manpower
                                models, like pharma & postman services,
                                prioritizing speed & accuracy.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                                  <Image
                                ...
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Real-time reconciliation & customer refund
                                </p>
                                <p className="text-black fw-600">
                                  <Image
                                    loader={myLoader}
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Resource deployment for maximum efficacy
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="col-lg-5">
                            <div className="p-2 bg-white card h-100">
                              ...
                              <div className="my-3">
                                <p className="fw-700">Partial returns</p>
                                <p className="fs-15">
                                  Partial Orders and Partial SKUs
                                </p>
                              </div>
                              <div className="my-3">
                                <p className="fw-700">Real-time</p>
              ...
              <div
                ...
                id="pills-lastmile"
                role="tabpanel"
                aria-labelledby="pills-lastmile-tab"
              >
                <div className="row d-flex">
                  <ul
                    className="nav nav-pills col-md-4 d-flex flex-column align-items-start "
                  ...
                  <div className="tab-content col-md-8" id="pills-tabContent">
                    <div
                      className="tab-pane fade show active"
                      id="pills-standardDelivery"
                      role="tabpanel"
                      aria-labelledby="pills-standardDelivery-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Have your order conveniently delivered to your
                                doorstep within just 4 hours.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                                  <Image
                                ...
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Instant gratification without waiting
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div
                      className="tab-pane fade"
                      id="pills-sameDayDelivery"
                      role="tabpanel"
                      aria-labelledby="pills-sameDayDelivery-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Experience the convenience of having your order
                                delivered right to your doorstep during office
                                hours.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                                ...
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Flexible timing for convenience.
                                </p>
                              </div>
                            </div>
                          </div>
                    ...
                    <div
                      className="tab-pane fade"
                      id="pills-nextDAyDelivery"
                      role="tabpanel"
                      aria-labelledby="pills-nextDAyDelivery-tab"
                    >
                      <div className="p-2 usage-bg">
                        <div className="mx-0 my-3 row w-100">
                          <div className="col-lg-7">
                            <div>
                              ...
                              <p className="my-2 text-dark">
                                Enjoy the prompt delivery of your order,
                                arriving at your doorstep within 1-2 business
                                days.
                              </p>
                              <div className="my-3">
                                <p className="text-black fw-600">
                                ...
                                <p className="text-black fw-600">
                                  <Image
                                    ...
                                    alt="Points"
                                  />{" "}
                                  Easy planning with 1-2 business day delivery.
                                </p>
                                <p className="text-black fw-600">
                                  <Image
                                    loader={myLoader}
                  ...
                  <div className="mx-0 my-3 row w-100">
                    <div className="col-lg-7">
                      <div>
                        ...
                        <p className="my-2 text-dark">
                          On-time, end-to-end forward logistics with a high
                          delivery percentage that caters to rapidly increasing
                          e-commerce demands, at lower costs.
                        </p>
                        <div className="my-3">
                          <p className="text-black fw-600">
                            <Image
                              ...
                              alt="Points"
                            />{" "}
                            Marketplace & warehouse pick-ups
                          </p>
                          <p className="text-black fw-600">
                            <Image
                              loader={myLoader}
              ...
              >
                ...
                <div
                  className={`tab-pane fade px-0 ${
                    activeTab === "pills-hyperlocal1" ? "show active" : ""
                  }`}
                  id="pills-hyperlocal1"
                  role="tabpanel"
                  aria-labelledby="pills-hyperlocal1-tab"
                >
                  <div className="px-0 row d-flex">
                    ...
                    <div
                      className="px-0 tab-content col-md-8"
                      id="pills-tabContent"
                    >
                      <div
                        className="tab-pane fade show active"
                        id="pills-ozOveNow1"
                        role="tabpanel"
                        aria-labelledby="pills-ozOveNow1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                            ...
                            <div className="col-lg-7">
                              <div>
                                <h2 className="my-2 text-dark fw-600 text-capitalize fs-22">
                                  Oz Ove Now Services
                                </h2>
                                <p className="my-2 text-dark fs-10">
                                  Low-cost & convenient deliveries, done under
                                  45 minutes, apt for food, pharma, & groceries
                                  orders
                                </p>
                                <div className="my-3">
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                                    <Image
                                      loader={myLoader}
                                      className="h-auto points"
                                      src={Points}
                          ...
                          <div className="mx-0 row w-100">
                            <div className="my-3">
                              <div className="p-3 card h-100 card_1">
                                <div className="d-flex justify-content-between">
                                  <div>
                                    <p className="text-dark text-uppercase fw-700 fs-12">
                                      Who is it for?
                                    </p>
                                  </div>
                                  <div>
                      ...
                      <div
                        className="tab-pane fade"
                        id="pills-retailLogistics1"
                        role="tabpanel"
                        aria-labelledby="pills-retailLogistics1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                      ...
                      <div
                        ...
                        id="pills-ozOvePlus1"
                        role="tabpanel"
                        aria-labelledby="pills-ozOvePlus1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                      ...
                      <div
                        ...
                        id="pills-ozOveNext1"
                        role="tabpanel"
                        aria-labelledby="pills-ozOveNext1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-7">
                              <div>
                                ...
                                <p className="my-2 text-dark fs-10">
                                  Crossed-utilised, dedicated & skilled
                                  logistics fleet for handling high-priority &
                                  critical documents, handled with utmost
                                  safety, at budget-friendly rates.
                                </p>
                                <div className="my-3">
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                                    <Image
                      ...
                      <div
                        ...
                        id="pills-nowSlot1"
                        role="tabpanel"
                        aria-labelledby="pills-nowSlot1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-7">
                              <div>
                                ...
                                <p className="my-2 text-dark fs-10">
                                  Our store pick-up model works with dark and
                                  live stores, handling slotted and express
                                  deliveries, doorstep returns, and fluctuations
                                  in consumer demands. Optimized for outsourced
                                  manpower models, like pharma & postman
                                  services, prioritizing speed & accuracy.
                                </p>
                                <div className="my-3">
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                                    <Image
                ...
                <li
                  className={`nav-item px-0 ${
                    activeTab === "pills-lastmile1" ? "" : "my-3"
                  }`}
                  role="presentation"
                >
                  <button
                    className={`nav-link w-100 px-1 d-flex justify-content-center flex-column align-items-center ${
                      activeTab === "pills-lastmile1" ? "active" : ""
                    }`}
                    id="pills-lastmile1-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-lastmile1"
                ...
                <div
                  className={`tab-pane fade ${
                    activeTab === "pills-lastmile1" ? "show active" : ""
                  }`}
                  id="pills-lastmile1"
                  role="tabpanel"
                  aria-labelledby="pills-lastmile1-tab"
                >
                  <div className="row d-flex">
                    ...
                    <div className="tab-content col-md-8" id="pills-tabContent">
                      <div
                        className="tab-pane fade show active"
                        id="pills-standardDelivery1"
                        role="tabpanel"
                        aria-labelledby="pills-standardDelivery1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                      ...
                      <div
                        className="tab-pane fade"
                        id="pills-sameDayDelivery1"
                        role="tabpanel"
                        aria-labelledby="pills-sameDayDelivery1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                            ...
                            <div className="col-lg-7">
                              <div>
                                ...
                                <p className="my-2 text-dark fs-10">
                                  ...
                                  order delivered right to your doorstep during
                                  office hours.
                                </p>
                                <div className="my-3">
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                      ...
                      <div
                        className="tab-pane fade"
                        id="pills-nextDayDelivery1"
                        role="tabpanel"
                        aria-labelledby="pills-nextDayDelivery1-tab"
                      >
                        <div className="px-0 usage-bg">
                          <div className="mx-0 my-3 row w-100">
                            <div className="col-lg-5">
                                ...
                                <div className="my-3">
                                  ...
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                                    <Image
                                      ...
                                      alt="Points"
                                    />{" "}
                                    Easy planning with 1-2 business day
                                    delivery.
                                  </p>
                                  <p className="text-black fs-14 fw-600 d-flex align-items-center">
                                    <Image
                ...
                <li
                  className={`nav-item px-0 ${
                    activeTab === "pills-ecommerce1" ? "" : "my-3"
                  }`}
                  role="presentation"
                >
                  <button
                    className={`nav-link w-100 px-1 d-flex justify-content-center flex-column align-items-center ${
                      activeTab === "pills-ecommerce1" ? "active" : ""
                    }`}
                    id="pills-ecommerce1-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-ecommerce1"
                ...
                <div
                  className={`tab-pane fade ${
                    activeTab === "pills-ecommerce1" ? "show active" : ""
                  }`}
                  id="pills-ecommerce1"
                  role="tabpanel"
                  aria-labelledby="pills-ecommerce1-tab"
                    ...
                    <div className="mx-0 my-3 row w-100">
                      ...
                      <div className="col-lg-7">
                        <div>
                          ...
                          <p className="my-2 text-dark fs-10">
                            On-time, end-to-end forward logistics with a high
                            delivery percentage that caters to rapidly
                            increasing e-commerce demands, at lower costs.
                          </p>
                          <div className="my-3">
                            <p className="text-black fs-14 fw-600 d-flex align-items-center">
                              <Image
