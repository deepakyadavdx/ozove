...
//                     <div className="p-0 bg-transparent border-0" style={{ width: "100%" }}>
...
//             </div>
//             {/* </div>
//           <div className="flex-wrap row align-items-start justify-content-center"> */}
      ...
      <div className="local_delivery_section section-spacer">
        <div className="container">
          <div className="flex-wrap row align-items-start justify-content-evenly">
            <div className={`card_width_1 ${isMobile ? "px-1 my-1" : "my-4"}`}>
              <div
                className={`inner_launching_section flex-column ${
                  isMobile ? "px-0" : "px-4"
                } ${
                  isExpanded["localDeliveryCollapseExample1"] ? "expanded" : ""
                }`}
                data-bs-toggle="collapse"
                href="#localDeliveryCollapseExample1"
                role="button"
                aria-expanded={isExpanded ? "true" : "false"}
                onClick={() => {
                  handleCollapse("localDeliveryCollapseExample1");
                }}
                aria-controls="localDeliveryCollapseExample1"
              >
                <div className="d-flex justify-content-center">
            ...
            <div className={`card_width_1 ${isMobile ? "px-1 my-1" : "my-4"}`}>
              <div
                className={`inner_launching_section flex-column ${
                  ...
                  isExpanded["localDeliveryCollapseExample2"] ? "expanded" : ""
                }`}
                data-bs-toggle="collapse"
                href="#localDeliveryCollapseExample2"
                role="button"
                aria-expanded={isExpanded ? "true" : "false"}
                onClick={() => {
                  handleCollapse("localDeliveryCollapseExample2");
                }}
                aria-controls="localDeliveryCollapseExample2"
              >
                <div className="d-flex justify-content-center">
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    ...
                    >
                      <p className="px-0 launching_description ">
                        Need to move sizable items like electronics, household
                        or garden furniture? we{`'`}ve got the capacity to
                        deliver
                      </p>
                    </div>
                  </div>
            ...
            <div className={`card_width_1 ${isMobile ? "px-1 my-1" : "my-4"}`}>
              <div
                className={`inner_launching_section flex-column ${
                  ...
                  isExpanded["localDeliveryCollapseExample3"] ? "expanded" : ""
                }`}
                data-bs-toggle="collapse"
                href="#localDeliveryCollapseExample3"
                role="button"
                aria-expanded={isExpanded ? "true" : "false"}
                onClick={() => {
                  handleCollapse("localDeliveryCollapseExample3");
                }}
                aria-controls="localDeliveryCollapseExample3"
              >
                <div className="d-flex justify-content-center">
            ...
            <div className={`card_width_2 ${isMobile ? "px-1 my-1" : "my-4"}`}>
              <div
                className={`inner_launching_section flex-column ${
                  ...
                  isExpanded["localDeliveryCollapseExample4"] ? "expanded" : ""
                }`}
                data-bs-toggle="collapse"
                href="#localDeliveryCollapseExample4"
                role="button"
                aria-expanded={isExpanded ? "true" : "false"}
                onClick={() => {
                  handleCollapse("localDeliveryCollapseExample4");
                }}
                aria-controls="localDeliveryCollapseExample4"
              >
                <div className="d-flex justify-content-center">
            ...
            <div className={`card_width_3 ${isMobile ? "px-1 my-1" : "my-4"}`}>
              <div
                className={`inner_launching_section flex-column ${
                  ...
                  isExpanded["localDeliveryCollapseExample5"] ? "expanded" : ""
                }`}
                data-bs-toggle="collapse"
                href="#localDeliveryCollapseExample5"
                role="button"
                aria-expanded={isExpanded ? "true" : "false"}
                onClick={() => {
                  handleCollapse("localDeliveryCollapseExample5");
                }}
                aria-controls="localDeliveryCollapseExample5"
              >
                <div className="d-flex justify-content-center">
