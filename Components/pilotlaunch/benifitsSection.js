...
//   };
//   return (
//     <div className="container py-4 ownFleet_section">
...
//           <div className="px-5 py-5 inner_ownfleet">
...
function BenifitsSection() {
  ...
  return (
    <div className="container py-4 ownFleet_section">
      ...
      <div
        className={`mx-0 row w-100 ownfleet_inner_section justify-content-lg-evenly ${
          isMobile ? "flex-nowrap my-1" : "flex-wrap my-3 px-4"
        }`}
      >
        <div className="my-2 pilotlaunch">
          <div className="px-5 py-5 inner_ownfleet">
