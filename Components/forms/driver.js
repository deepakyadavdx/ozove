...
//               <div className="px-3 inner_apply_driver_form">
//                 {!isMobile ? (
//                   <>
...
//                       />
//                     </div>
//                     <p className="py-1 mt-3 small-paragraph deliver_title_description w-lg-75">
//                       Become a driver
//                     </p>
//                     <div className="mb-2 become_border_custom w-25"></div>
//                   </>
//                 ) : (
//                   <>
          ...
          <Form onSubmit={handleSubmit} className="apply_driver_form">
            <div className="px-3 inner_apply_driver_form">
              {!isMobile ? (
                ...
                <>
                  <p className="fs-20 fw-700 third_title text-grey">Sign up</p>
                </>
              )}
              <FormGroup className="inner_driver_form_input">
                <Label>
