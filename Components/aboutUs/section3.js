...
//               <div className="order-2 px-0 col-lg-6 order-lg-1">
//                 <div className="my-3">
...
//                 </div>
//               </div>
//               <div className="order-1 px-0 col-lg-6 order-lg-2">
//                 <div>
          ...
          <div className={`${isMobile ? "card bg-grey" : ""}`}>
            <div className="mx-0 row w-100 align-items-center">
              <div className="order-2 px-0 col-lg-6 order-lg-1">
                ...
                <div>
                  <p className="about_our_story_desc">
                    Founded in 2023, we observed the gaps in traditional
                    delivery and ride services. We saw an opportunity to
                    innovate, to combine the best of both worlds and create a
                    seamless, hyperlocal experience that caters to the specific
              ...
              <div className="order-1 px-0 col-lg-6 order-lg-2">
                <div>
                  <Image
                    ...
                    src={OurStory}
                    alt="OurStory"
                    style={{ marginBottom: isLaptop ? "0" : "-6.5px" }}
                  />
                </div>
              </div>
            </div>
