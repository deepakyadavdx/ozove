...
//                 <div className="px-3 py-3 our_core_valuesSection">
//                   <div>
//                     <p className="our_core_head">Customer Focus</p>
//                     <p className="my-3 our_core_desc">
...
function OurValuesSection() {
  ...
  return (
    <>
      <div
        className={`our_core_values_section ${isMobile ? "" : "py-5 bg-grey"}`}
      >
        <div className={`container`}>
          <div className={`${isMobile ? "card bg-grey" : ""}`}>
            <div className="m-3 my-lg-3">
            ...
            <div
              className={`${
                isMobile
                  ? "row mb-4 our_core_values_section flex-nowrap"
                  : "row mb-4 our_core_values_section flex-wrap mt-3"
              }`}
            >
              <div className="col-lg-3 col-md-6 col-8">
                <div className="px-3 py-3 our_core_valuesSection">
