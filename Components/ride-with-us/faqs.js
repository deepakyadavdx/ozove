...
//                     {faqsList.map((faq, i) =>
//                       i < 4 ? (
//                         <div className="my-3 accordion-item" key={i}>
//                           <h2
...
//                           >
//                             <div className="py-0 accordion-body">
//                               <p className="text-black faq_desc fw-400">
//                                 {faq.ans}
//                               </p>
//                             </div>
//                           </div>
//                         </div>
//                       ) : showMore ? (
//                         <div className="my-3 accordion-item">
//                           <h2
//                             className="small-paragraph accordion-header faq_title"
//                             id={`flush-heading${i}`}
//                           >
...
//                   {faqsList.length > 4 ? (
//                     <button
//                       className="px-4 py-2 read_more_btn"
                          ...
                          <div className="my-3 accordion-item" key={i}>
                            ...
                            >
                              <button
                                ...
                                aria-expanded="false"
                                aria-controls={`flush-collapse${i}`}
                                style={{ "--bs-accent": "#ffc107 !important" }}
                              >
                                {faq.que}
                              </button>
                            </h2>
