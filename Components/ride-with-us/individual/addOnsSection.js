...
//         <div className="px-4 addonssection section-spacer">
//           <div className="row">
...
//             <div className="py-3 m-3 col-lg-4 col-md-6 col-11 m-lg-0" style={{backgroundColor: isMobile ? "#fff" : ""}}>
//               <div className="adons_description">
//                 <div className="mx-0 row align-items-center">
//                   <div className="px-0 col-md-3 d-flex justify-content-lg-center">
      ...
      <div className="container">
        <div className="px-4 addonssection section-spacer">
          <div className="row">
            <div className="col-12">
              ...
              {isMobile ? (
                <p className="adons_description1">
                  Choose Oz Ove for a transportation experience that goes above
                  and beyond. Expect the extraordinary.
                </p>
              ) : (
                <p className="adons_description1">
                  Choose Oz Ove for a transportation experience that goes above
          ...
          <div
            className={
              isMobile
                ? "row my-4 addons_inner_section flex-nowrap"
                : "row my-4 addons_inner_section flex-wrap"
            }
          >
            <div
              className="py-3 m-3 col-lg-4 col-md-6 col-11 m-lg-0"
                ...
                <div className="mx-0 row align-items-center">
                  <div className="px-0 col-md-3 d-flex justify-content-lg-center">
                    <Image
                      loader={myLoader}
                      className="h-auto object-fit-contain"
                      src={DisabilitySupportDriver}
                      alt="DisabilitySupportDriver"
                      style={{ width: isMobile ? "15%" : "80%" }}
                    />
                  </div>
                  <div className="px-0 col-md-9">
