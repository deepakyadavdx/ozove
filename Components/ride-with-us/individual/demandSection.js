...
//               >
//                 <button
//                   className="px-1 nav-link w-100 d-flex justify-content-center flex-column align-items-center pills-ozVan"
//                   data-bs-toggle="pill"
...
//               </li>
//               <li
//                 className="my-3 nav-item col-lg-3 main-li dropdown"
//                 role="presentation"
//               >
//                 <button
//                   className="px-1 nav-link w-100 d-flex justify-content-center flex-column align-items-center"
//                   id="pills-ozBus-tab"
//                   data-bs-toggle="pill"
...
//                 id="pills-ozVan"
//                 role="tabpanel"
//                 aria-labelledby="pills-ozVan-tab"
//               >
...
//                       id="pills-standardVan"
//                       role="tabpanel"
//                       aria-labelledby="pills-standardVan-tab"
//                     >
...
//                                 Roomy and comfortable, our standard vans offer
...
//                       id="pills-accessibleVan"
//                       role="tabpanel"
//                       aria-labelledby="pills-accessibleVan-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Designed with inclusivity in mind, our Access
//                                 Vans provide ample space for wheelchair users
//                                 and easy accessibility for a smooth ride.
//                               </p>
//                               <div className="my-3">
//                                 <p className="text-black">
//                                   <Image
...
//                       id="pills-partyVan"
//                       role="tabpanel"
//                       aria-labelledby="pills-partyVan-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Add a touch of fun to your ride! Our party vans
//                                 come equipped with a premium sound system and
//                                 vibrant lighting, perfect for starting the
...
//                       id="pills-premiumVan"
//                       role="tabpanel"
//                       aria-labelledby="pills-premiumVan-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Experience a touch of luxury with our Elite
//                                 Vans. With spacious interiors, comfortable
//                                 seating, and top-notch amenities, your journey
...
//                 id="pills-ozBus"
//                 role="tabpanel"
//                 aria-labelledby="pills-ozBus-tab"
//               >
//                 <div className="row d-flex">
//                   <ul
//                     className="nav nav-pills col-md-4 d-flex flex-column align-items-start"
...
//                       id="pills-smallBus"
//                       role="tabpanel"
//                       aria-labelledby="pills-smallBus-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Compact yet comfortable, our Mini Buses are
//                                 perfect for smaller groups. Enjoy a relaxed
//                                 journey with us, no matter your destination.
//                               </p>
//                               <div className="my-3">
//                                 <p className="text-black">
//                                   <Image
...
//                       id="pills-mediumBus"
//                       role="tabpanel"
//                       aria-labelledby="pills-mediumBus-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Oz Midi Bus - Striking a perfect balance between
//                                 capacity and comfort, our Midi Buses cater to
//                                 larger groups, ensuring everyone arrives
...
//                       id="pills-largeBus"
//                       role="tabpanel"
//                       aria-labelledby="pills-largeBus-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Designed for big groups, our Maxi Buses offer
//                                 ample space, ensuring everyone's comfort on the
//                                 go. Ideal for corporate events, large
...
//                       id="pills-partyBus"
//                       role="tabpanel"
//                       aria-labelledby="pills-partyBus-tab"
//                     >
//                       <div className="p-2 usage-bg">
//                         <div className="mx-0 my-3 row w-100">
//                           <div className="col-lg-7">
...
//                               </h2>
//                               <p className="my-2 text-dark">
//                                 Oz Fiesta Bus - Turn up the fun with our Fiesta
//                                 Buses. Decked out with a sound system and party
//                                 lights, these buses bring the party to you, no
...
//                 id="pills-ozPremium"
//                 role="tabpanel"
//                 aria-labelledby="pills-ozPremium-tab"
//               ></div>
//             </div>
//           </div>
...
//                     activeTab === "pills-ozVan1" ? "show active" : ""
//                   }`}
//                   id="pills-ozVan1"
//                   role="tabpanel"
//                   aria-labelledby="pills-ozVan1-tab"
//                 >
...
//                       <div
//                         className="tab-pane fade show active"
//                         id="pills-standardVan1"
//                         role="tabpanel"
//                         aria-labelledby="pills-standardVan1-tab"
//                       >
...
//                       <div
//                         className="tab-pane fade"
//                         id="pills-accessibleVan1"
//                         role="tabpanel"
//                         aria-labelledby="pills-accessibleVan1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                         id="pills-partyVan1"
//                         role="tabpanel"
//                         aria-labelledby="pills-partyVan1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                                 </h2>
//                                 <p className="my-2 text-dark fs-10">
//                                   Add a touch of fun to your ride! Our party
//                                   vans come equipped with a premium sound system
//                                   and vibrant lighting, perfect for starting the
//                                   celebration on the road."
//                                 </p>
//                                 <div className="my-3">
//                                   <p className="text-black fs-14">
...
//                       <div
//                         className="tab-pane fade"
//                         id="pills-premiumVan1"
//                         role="tabpanel"
//                         aria-labelledby="pills-premiumVan1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                 <li
//                   className={`nav-item px-0 ${
//                     activeTab === "pills-ozBus1" ? "" : "my-3"
//                   }`}
//                   role="presentation"
//                 >
//                   <button
//                     className={`nav-link w-100 px-1 d-flex justify-content-center flex-column align-items-center ${
//                       activeTab === "pills-ozBus1" ? "active" : ""
//                     }`}
//                     id="pills-ozBus1-tab"
//                     data-bs-toggle="pill"
...
//                 <div
//                   className={`tab-pane fade ${
//                     activeTab === "pills-ozBus1" ? "show active" : ""
//                   }`}
//                   id="pills-ozBus1"
//                   role="tabpanel"
//                   aria-labelledby="pills-ozBus1-tab"
//                 >
//                   <div className="px-0 row d-flex">
//                     <ul className="nav nav-pills" id="pills-tab" role="tablist">
//                       <li className="my-2 nav-item" role="presentation">
...
//                         id="pills-smallBus1"
//                         role="tabpanel"
//                         aria-labelledby="pills-smallBus1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                         id="pills-mediumBus1"
//                         role="tabpanel"
//                         aria-labelledby="pills-mediumBus1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                                 </h2>
//                                 <p className="my-2 text-dark fs-10">
//                                   Oz Midi Bus - Striking a perfect balance
//                                   between capacity and comfort, our Midi Buses
//                                   cater to larger groups, ensuring everyone
...
//                         id="pills-largeBus1"
//                         role="tabpanel"
//                         aria-labelledby="pills-largeBus1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                                 <p className="my-2 text-dark fs-10">
//                                   Designed for big groups, our Maxi Buses offer
//                                   ample space, ensuring everyone's comfort on
//                                   the go. Ideal for corporate events, large
//                                   gatherings, or group tours.
//                                 </p>
//                                 <div className="my-3">
//                                   <p className="text-black fs-14">
...
//                         id="pills-partyBus1"
//                         role="tabpanel"
//                         aria-labelledby="pills-partyBus1-tab"
//                       >
//                         <div className="px-0 usage-bg">
//                           <div className="mx-0 my-3 row w-100">
//                             <div className="col-lg-5">
...
//                                 </h2>
//                                 <p className="my-2 text-dark fs-10">
//                                   Oz Fiesta Bus - Turn up the fun with our
//                                   Fiesta Buses. Decked out with a sound system
//                                   and party lights, these buses bring the party
//                                   to you, no matter where you're headed.
//                                 </p>
//                                 <div className="my-3">
//                                   <p className="text-black fs-14">
//                                     <Image
...
//                 <li
//                   className={`nav-item px-0 ${
//                     activeTab === "pills-ozPremium1" ? "" : "my-3"
//                   }`}
//                   role="presentation"
//                 >
//                   <button
//                     className={`nav-link w-100 px-1 d-flex justify-content-center flex-column align-items-center ${
//                       activeTab === "pills-ozPremium1" ? "active" : ""
//                     }`}
...
//                 <div
//                   className={`tab-pane fade ${
//                     activeTab === "pills-ozPremium1" ? "show active" : ""
//                   }`}
//                   id="pills-ozPremium1"
//                   role="tabpanel"
//                   aria-labelledby="pills-ozPremium1-tab"
//                 ></div>
//               </ul>
//             </div>
//           </div>
                          ...
                          <div className="mx-0 my-3 row w-100">
                            ...
                            <div className="col-lg-7">
                              <div>
                                ...
                                <p className="my-2 text-dark fs-10">
                                  Designed for big groups, our Maxi Buses offer
                                  ample space, ensuring everyone&apos;s comfort
                                  on the go. Ideal for corporate events, large
                                  gatherings, or group tours.
                                </p>
                                <div className="my-3">
                                  <p className="text-black fs-14">
