...
//         <div className="container py-4 howitsworkpage bg-grey">
//           <div className="row">
//             <div className="col-12">
//               <p className="howitsworktitle">How it works</p>
//               <p className="mt-2 howitsworkdesc">
...
//                 <p className="mt-2 innerhowitsworkdesc">
        ...
        <div className="container py-4 howitsworkpage bg-grey">
          <div className="row">
            <div className="col-12">
              <p className="howitsworktitle">How it works</p>
              <p className="mt-2 howitsworkdesc">
                Experience the Revolution of Oz Ove&apos;s Unparalleled
                On-Demand Group Transportation
              </p>
            </div>
          </div>
          <div className="row">
            <div className="px-1 howitworkcard">
              <div className="py-5 my-3 howitsworksection d-flex justify-content-center flex-column align-items-center">
                <Image
                  ...
                  src={SetDeliveryRoute}
                  alt="SetDeliveryRoute"
                  style={{ width: "18%" }}
                />
                <p className="mt-2 innerhowitsworkdesc">Set Route</p>
              </div>
            ...
            <div className="px-1 howitworkcard">
              <div className="py-5 my-3 howitsworksection d-flex justify-content-center flex-column align-items-center">
                <Image
                  loader={myLoader}
                  className="h-auto object-fit-contain"
                  src={SelectVehicleType}
                  alt="SelectVehicleType"
                  style={{ width: "18%" }}
                />
                <p className="mt-2 innerhowitsworkdesc">Select Vehicle Type</p>
              </div>
            ...
            <div className="px-1 howitworkcard">
              <div className="py-5 my-3 howitsworksection d-flex justify-content-center flex-column align-items-center">
                <Image
                  loader={myLoader}
                  className="h-auto object-fit-contain"
                  src={PersonaliseAddOns}
                  alt="PersonaliseAddOns"
                  style={{ width: "18%" }}
                />
                <p className="mt-2 innerhowitsworkdesc">Personalise Add-Ons</p>
              </div>
            ...
            <div className="px-1 howitworkcard">
              <div className="py-5 my-3 howitsworksection d-flex justify-content-center flex-column align-items-center">
                <Image
                  loader={myLoader}
                  className="h-auto object-fit-contain"
                  src={TrackDriverInRealTime}
                  alt="TrackDriverInRealTime"
                  style={{ width: "18%" }}
                />
                <p className="mt-2 innerhowitsworkdesc">
                  Track Driver in Real Time
