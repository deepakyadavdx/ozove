...
export const metadata = {
  ...
  description:
    "Open our app and get instant pricing details before you place an order. Get started right away and experience peace of mind with our local delivery solutions.",
};
